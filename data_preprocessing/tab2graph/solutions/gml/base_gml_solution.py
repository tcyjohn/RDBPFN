...
from ..encoders import IdDictEncoder
from .graph_feat_encoder import GraphFeatDictEncoder
...
class BaseGMLSolution(GraphMLSolution):
    ...
    def _create_dataloader(
        ...
        if self.solution_config.use_multiprocessing:
            num_workers = min(self.solution_config.max_num_dataloader_workers, device.cpu_count // 2)
