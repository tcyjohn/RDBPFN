    ...
    **kwargs : dict
    ...
    def __init__(
        ...
        **kwargs: Dict[str, Any],
        ...
        # Build layers
        first_in_dim = self.num_causes + self.other_causes
    ...
    def forward_with_input(
        ...
        assert causes.shape[1] == self.num_causes + self.other_causes, (
            f"Expected {self.num_causes + self.other_causes} input dims, "
